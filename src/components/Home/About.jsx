        ...
        <Row>
          <Col md={8} className="home-about-description" data-aos='fade-up'>
            ...
            <p className="home-about-body">
              Hi, my name is <span className="yellow">Walter Hagen</span>
              and I'm from <span className="yellow"> Helsinki, Finland.</span>
              <br />
              <br />
              I graduated with a Bachelor's degree in Computer Science and Engineering in 2017.
              <br />
              <br />
              As a
              ...
              <br />
              <br />
              I have a lot of experience with MERN Stack and Laravel applications.
              <br />
              <br />
